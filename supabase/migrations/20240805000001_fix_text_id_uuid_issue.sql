-- Drop and recreate the legal_texts table with proper column types
DROP TABLE IF EXISTS annotations CASCADE;
DROP TABLE IF EXISTS annotation_votes CASCADE;
DROP TABLE IF EXISTS legal_texts CASCADE;

-- Recreate the legal_texts table with proper column types
CREATE TABLE IF NOT EXISTS legal_texts (
  ...
  passage_no VARCHAR(50),
  textunit_no VARCHAR(50),
  header TEXT,
  text TEXT,
